...
<head>
  ...
  <title>Dashboard Admin - Data Absensi</title>
  <link
    rel="stylesheet"
  ...
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          >
            ...
            <li class="nav-item">
              <a href="/absensis" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="mb-3">
            <a href="{{ route('absensis.create') }}" class="btn btn-tambah"
              >Tambah Absensi</a
            >
          </div>
          ...
          <table class="table table-custom table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td>{{ $absensi->pegawai->nama ?? 'Data tidak ditemukan' }}</td>
                <td>{{ $absensi->tanggal }}</td>
                <td>{{ $absensi->status }}</td>
                <td>
                  <a
                    href="{{ route('absensis.edit', $absensi->id) }}"
                    class="btn btn-edit btn-sm"
                    >Edit</a
                  >
                  <form
                    action="{{ route('absensis.destroy', $absensi->id) }}"
                    method="POST"
              ...
              @if($absensis->isEmpty())
              <tr>
                <td colspan="4" class="text-center">Data Absensi tidak ditemukan.</td>
              </tr>
              @endif
            </tbody>
          </table>
