...
<head>
  ...
  <title>Dashboard Admin - Data Karyawan</title>
  <link
    rel="stylesheet"
  ...
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          >
            ...
            <li class="nav-item">
              <a href="/pegawais" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="mb-3">
            <a href="{{ route('pegawais.create') }}" class="btn btn-tambah"
              >Tambah Karyawan</a
            >
          </div>
          ...
          <table class="table table-custom table-bordered">
            ...
            <tbody>
             ...
             <td>{{ $karyawan->jabatan->nama ?? '-' }}</td>
                ...
                <td>
                  <a
                    href="{{ route('pegawais.edit', $karyawan->id) }}"
                    class="btn btn-edit btn-sm"
                    >Edit</a
                  >
                  <form
                    action="{{ route('pegawais.destroy', $karyawan->id) }}"
                    method="POST"
